...
#define DLOG_TRACE(...)                                                                     \
    do {                                                                                    \
        if (base::Logger::logLevel() <= base::Logger::TRACE)                                \
            print(base::Logger(__FILE__, __LINE__, base::Logger::TRACE, __func__).stream(), \
                  __VA_ARGS__);                                                             \
    } while (0)
...
#define DLOG_DEBUG(...)                                                                     \
    do {                                                                                    \
        if (base::Logger::logLevel() <= base::Logger::DEBUG)                                \
            print(base::Logger(__FILE__, __LINE__, base::Logger::DEBUG, __func__).stream(), \
                  __VA_ARGS__);                                                             \
    } while (0)
...
#define DLOG_ERROR(...)                                                                         \
    do {                                                                                        \
        if (base::Logger::logLevel() <= base::Logger::ERROR)                                    \
            print(base::Logger(__FILE__, __LINE__, base::Logger::ERROR).stream(), __VA_ARGS__); \
    } while (0);

#define DLOG_WARN(...)                                                                         \
    do {                                                                                       \
        if (base::Logger::logLevel() <= base::Logger::WARN)                                    \
            print(base::Logger(__FILE__, __LINE__, base::Logger::WARN).stream(), __VA_ARGS__); \
    } while (0)

#define DLOG_FATAL(...)                                                                         \
    do {                                                                                        \
        if (base::Logger::logLevel() <= base::Logger::FATAL)                                    \
            print(base::Logger(__FILE__, __LINE__, base::Logger::FATAL).stream(), __VA_ARGS__); \
    } while (0)
