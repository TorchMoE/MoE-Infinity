...
// replaced CPUCachingAllocator with HostCachingAllocator
 ...
 * std::unique_ptr<c10::HostCachingAllocator> caching_allocator =
 *   std::make_unique<c10::HostCachingAllocator>();
 * Use caching allocator with a scoped guard at inference time.
 * {
 * WithHostCachingAllocatorGuard(caching_allocator.get());
 * ... model.forward(...);
 * }
 */
...
extern HostCachingAllocator* caching_allocator;

extern HostCachingAllocator* get();
}  // namespace HostCachingAllocator
